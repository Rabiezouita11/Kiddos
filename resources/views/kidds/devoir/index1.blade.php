      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">إمتحانات</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="{{route('index')}}">الصفحة الرئيسية <i class="ion-ios-arrow-forward"></i></a></span> <span>إمتحانات <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
				...
				<div class="row">
					<div class="col-md-6 course d-lg-flex ftco-animate">
						...
						<div class="text bg-light p-4">
							<h3><a href="{{route('devoir')}}">  امتحانات الكترونية في مادة القراءة للسنة الرابعة أساسي :  (1)  </a></h3>
					...
					<div class="col-md-6 course d-lg-flex ftco-animate">
						...
						<div class="text bg-light p-4">
							<h3><a href="{{route('index2')}}">  امتحانات ورقية في مادة القراءة للسنة الرابعة اساسي           :  (@widget('countdevoir')) </a></h3>
