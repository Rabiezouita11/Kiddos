				...
				<div class="row">
					<div class="col-md-6 course d-lg-flex ftco-animate">
						...
						<div class="text bg-light p-4">
							<h3><a href="{{route('drous')}}">           دروس الكترونية في مادة القراءة للسنة الرابعة أساسي          :       (3)    
 </a></h3>
					...
					<div class="col-md-6 course d-lg-flex ftco-animate">
						...
						<div class="text bg-light p-4">
							<h3><a href="{{route('indexdrous')}}">           دروس ورقية في مادة القراءة للسنة الرابعة أساسي                  :    (@widget('countdars'))    </a></h3>
