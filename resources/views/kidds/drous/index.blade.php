      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">دروس</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="{{route('index')}}">الصفحة الرئيسية <i class="ion-ios-arrow-forward"></i></a></span> <span>دروس <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img"   style="background-image: url(1111.png);"></div>
						<div class="text bg-light p-4">
							<h3><a href="{{route('devoirtest')}}">نَّصُّ جَلْسَةُ سَمَرٍ للسَّنَةِ الرَّابِعَة ، الوِحْدَة الثَّالِثَة </a></h3>
						
							
						</div>
					</div>
					<div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img"   style="background-image: url(2222.png);"></div>
						<div class="text bg-light p-4">
							<h3><a href="{{route('dars2')}}">نَّصُّ المَارِدُ و سُكَّانُ القَرْيَة (1) للسَّنَةِ الرَّابِعَة ، الوِحْدَة الرَّابِعَة </a></h3>
					
							
						</div>
					</div>
                    <div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img"   style="background-image: url(333.png);"></div>
						<div class="text bg-light p-4">
							<h3><a href="{{route('dars3')}}">نَّصُّ المَارِدُ و سُكَّانُ القَرْيَة (2) للسَّنَةِ الرَّابِعَة ، الوِحْدَة الرَّابِعَة </a></h3>
