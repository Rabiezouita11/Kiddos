...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <h1 class="message__title">الصفحة غير موجودة</h1>
      <p class="message__text">نأسف ، الصفحة التي تبحث عنها غير موجودة هنا. ربما يكون الارتباط الذي اتبعته معطلاً أو لم يعد موجودًا. يرجى المحاولة مرة أخرى ، أو إلقاء نظرة على.</p>
    </div>
