...
<div class="container">
 	<br/>
 	 	<h2 class="text-center">إدْمَاج فِي القِرَاءة</h2>
 	<br/>
     <?php
$b = DB::table('resultat_idmajs')->where('nom','=',$produits->name)->get(); 
$a=$b->sum('score')  ;
     ?>
...
<center><a href="{{route('resultatdevoiridmaj')}}"> <button  class="btn btn-warning pull-right">retour</button></a></center>
