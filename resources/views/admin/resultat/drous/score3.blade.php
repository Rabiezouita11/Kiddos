...
<div class="container">
 	<br/>
 	 	<h2 class="text-center">(2)نَّصُّ المَارِدُ و سُكَّانُ القَرْيَة </h2>
 	<br/>
     <?php
$b = DB::table('resultatdars3s')->where('nom','=',$produits->name)->get(); 
$a=$b->sum('score')  ;
     ?>
...
<center><a href="{{route('resultatdevoirdars3')}}"> <button  class="btn btn-warning pull-right">retour</button></a></center>
