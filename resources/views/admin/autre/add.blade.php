...
<body>
<div class="container">
<h2 class="text-center">اضف فيديوهات</h2>
<form action="{{route('Ajoutautre')}}" method="post"  enctype="multipart/form-data"  >
...
@endif</div>
          ...
          <input class="form-control" type="hidden" name="etat" value="admin" required>
          <?php
$x=Auth::user()->name;
          ?>
 ...
 <a href="{{route('autree')}}" class="btn btn-default">لالغاء</a>
